import { Component, OnChanges, ElementRef, ViewChild, Input, TemplateRef, SimpleChanges, AfterViewInit, Output, EventEmitter } from '@angular/core';
...
export class NodeComponent implements OnChanges, AfterViewInit {
  ...
  clickArrowRigthEvent2(nodeState: NodeState) {
    this.clickArrowRigthEvent.emit(nodeState);
  }
