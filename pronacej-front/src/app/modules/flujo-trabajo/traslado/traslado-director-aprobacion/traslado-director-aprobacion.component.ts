...
@Component({
  selector: 'app-traslado-director-aprobacion',
  standalone: true,
  imports: [
    FormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './traslado-director-aprobacion.component.html',
  styleUrl: './traslado-director-aprobacion.component.scss'
})
export class TrasladoDirectorAprobacionComponent implements OnInit {
  ...
  rechazarTraslado() {
    let ref = this.dialogMensajeService.mensajeConConfirmacion(
      'Se rechazará el traslado actual',
      "Deseas continuar?"
    );
    ...
    ref.afterClosed().subscribe(
      {
        next: (resp: "confirmed" | "cancelled") => {
          if (resp == "confirmed") {
            ...
            this.trasladoService.rechazarTraslado(tareaTraslado, '').subscribe(
              {
