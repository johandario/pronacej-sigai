...
@Entity
@Data
@Table(name = "ia_pertenencia_documento")
@EqualsAndHashCode(of = {"idPertenenciaDocumento"}, callSuper = true)
@Comment("Tabla de pertenencias que se relacionad con documentos")
public class PertenenciaDocumento extends EntidadBase {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("Identificador principal de la tabla")
    private Long idPertenenciaDocumento;
    ...
    @JoinColumn(name = "id_pertenencia", referencedColumnName = "idPertenencia")
    @ManyToOne(fetch = FetchType.LAZY)
