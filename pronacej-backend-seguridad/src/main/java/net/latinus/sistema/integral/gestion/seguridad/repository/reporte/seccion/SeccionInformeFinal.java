 ...
 */
@Component
public class SeccionInformeFinal implements SeccionExportacionDinamica {
    static final String INFORME_FINAL_CJDR = "ENCUESTA_INFORME_FINAL_CJDR";

    @Override
    public String getNemonico() {
        return EtiquetaNemonico.SECCION_FICHA_IDENT_INFORME_FINAL;
    }

    @Override
    public String getAliasPivot() {
        return "inf_final_pivot";
    }
