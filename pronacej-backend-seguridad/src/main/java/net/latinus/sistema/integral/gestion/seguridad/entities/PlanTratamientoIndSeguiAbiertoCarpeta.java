...
@Entity
@Data
@Table(name = "ia_plan_tratamiento_ind_segui_abierto_carpeta")
@EqualsAndHashCode(of = {"idPlanTratamientoIndSeguiAbiertoCarpeta"}, callSuper = true)
@Comment("Tabla de ficha de seguimiento de pti abierto que se relaciona con carpetas")
public class PlanTratamientoIndSeguiAbiertoCarpeta extends EntidadBase {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("Identificador principal de la tabla")
    private Long idPlanTratamientoIndSeguiAbiertoCarpeta;
