...
@Entity
@Data
@Table(name = "seg_ficha_asistencia_post_egreso_documento")
@EqualsAndHashCode(of = {"idFichaAsistenciaPostEgresoDocumento"}, callSuper = true)
@Comment("Tabla de fichas de asistencia post egreso que se relacionan con documentos")
public class FichaAsistenciaPostEgresoDocumento extends EntidadBase {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("Identificador principal de la tabla")
    private Long idFichaAsistenciaPostEgresoDocumento;
