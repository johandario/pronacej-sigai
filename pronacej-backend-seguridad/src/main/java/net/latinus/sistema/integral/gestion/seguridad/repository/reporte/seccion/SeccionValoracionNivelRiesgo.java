 ...
 */
@Component
public class SeccionValoracionNivelRiesgo implements SeccionExportacionDinamica {
    static final String NEMONICO_EVALUACION_PSICOLOGICA = "ENCUESTA_FACTORES_DE_RIESGO";

    @Override
    public String getNemonico() {
        return EtiquetaNemonico.SECCION_FICHA_IDENT_NIVEL_RIESGO;
    }

    @Override
    public String getAliasPivot() {
        return "val_niv_riesgo_pivot";
    }
