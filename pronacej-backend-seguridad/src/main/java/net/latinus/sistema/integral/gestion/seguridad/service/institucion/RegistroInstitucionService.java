...
public interface RegistroInstitucionService {
    /**
     ...
     */
    RespuestaPorDefectoAuditoria<PaginacionResponse<RegistroInstitucionDTO>> obtenerInstituciones(HttpServletRequest httpServletRequest, BodyEncriptado bodyEncriptado);
     ...
     */
    RespuestaPorDefectoAuditoria<RegistroInstitucionDTO> obtenerRegistroInstitucionPorToken(HttpServletRequest httpServletRequest, String tokenIdentificador);
     ...
     */
    RespuestaPorDefectoAuditoria<RegistroInstitucionDTO> crearRegistroInstitucion(HttpServletRequest httpServletRequest, BodyEncriptado bodyEncriptado);
     ...
     */
    RespuestaPorDefectoAuditoria<List<RegistroInstitucionDTO>> obtenerTodasLasInstituciones(HttpServletRequest httpServletRequest);


    RespuestaPorDefectoAuditoria<RegistroInstitucionDTO> obtenerRegistroInstitucionPorRuc(
