 ...
 */
@Component
public class SeccionEvaluacionConductual implements SeccionExportacionDinamica {
    static final String EVALUACIÓN_CONDUCTUAL_AMBOS = "ENCUESTA_EVALUACIÓN_CONDUCTUAL_AMBOS";

    @Override
    public String getNemonico() {
        return EtiquetaNemonico.SECCION_FICHA_IDENT_EVALUACION_CONDUCTUAL;
    }

    @Override
    public String getAliasPivot() {
        return "eval_conduct_pivot";
    }
    ...
    public String getSqlFuentePivot() {
        return """
                ...
                """.formatted(EVALUACIÓN_CONDUCTUAL_AMBOS);
    }
