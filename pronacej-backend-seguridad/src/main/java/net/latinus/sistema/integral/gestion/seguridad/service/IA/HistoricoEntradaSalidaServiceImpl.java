        ...
        try{
            ...
            if(nemonioMotivoSalida.equals("SALIDA_TRASLADO")){
                ...
                if(!ObjectUtils.isEmpty(historico.getExternamiento())){
                    ...
                    dto.setInformeFinalAbierto(entidadADtoInformeFinal(historico.getInformeFinalAbierto()));
                }
