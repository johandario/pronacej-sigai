...
@Entity
@Data
@Table(name = "ia_expediente_matriz_detalle_documento")
@EqualsAndHashCode(of = {"idExpedienteDetalleDocumento"}, callSuper = true)
@Comment("Tabla de expedientes que se relacionad con los documentos")
public class ExpedienteMatrizDetalleDocumento extends EntidadBase {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("Identificador principal de la tabla")
    private Long idExpedienteDetalleDocumento;
