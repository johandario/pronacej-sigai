...
@Entity
@Data
@Table(name = "ia_seguimiento_educativo_laboral_carpeta")
@EqualsAndHashCode(of = {"idSeguimientoEducativoLaboralCarpeta"}, callSuper = true)
@Comment("Tabla de evaluación domiciliaria que se relaciona con carpetas")
public class SeguimientoEducativoLaboralCarpeta extends EntidadBase {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("Identificador principal de la tabla")
    private Long idSeguimientoEducativoLaboralCarpeta;
