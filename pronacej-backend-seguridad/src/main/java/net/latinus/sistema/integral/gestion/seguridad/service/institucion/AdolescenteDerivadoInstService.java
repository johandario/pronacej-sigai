...
public interface AdolescenteDerivadoInstService {
    /**
     ...
     */
    RespuestaPorDefectoAuditoria<PaginacionResponse<AdolescenteDerivadoInstDTO>> obtenerInstituciones(HttpServletRequest httpServletRequest, BodyEncriptado bodyEncriptado);
     ...
     */
    RespuestaPorDefectoAuditoria<AdolescenteDerivadoInstDTO> obtenerRegistroInstitucionPorToken(HttpServletRequest httpServletRequest, String tokenIdentificador);
     ...
     */
    RespuestaPorDefectoAuditoria<AdolescenteDerivadoInstDTO> crearRegistroInstitucion(HttpServletRequest httpServletRequest, BodyEncriptado bodyEncriptado);
     ...
     */
    RespuestaPorDefectoAuditoria<List<AdolescenteDerivadoInstDTO>> obtenerTodasLasInstituciones(HttpServletRequest httpServletRequest);
}
