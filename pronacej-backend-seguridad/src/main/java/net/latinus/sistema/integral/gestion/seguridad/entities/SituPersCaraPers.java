...
@Entity
@Data
@Table(name = "ia_situ_pers_cara_pers")
@EqualsAndHashCode(of = {"idSituPersCaraPers"}, callSuper = true)
public class SituPersCaraPers extends EntidadBase{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Comment("id de la tabla")
    private Long idSituPersCaraPers;
